...
const DocCard = ({docter}) => {
    ...
    const {_id,name,specialization,avgRating,totalRating,totalPatients,hospital,about,image} = docter
  ...
  return (
    <div className='p-3 lg:p-5 ' >
        <div style={{height:"50%"}}>
            <img src={`http://localhost:3001/img/${image}`} className='w-full ' style={{height:"100%"}}  alt="" />
        </div>
