...
<div className='absolute z-20 bottom-4 w-[200px] md:w-[-30%] md:right-[-7%] lg:right-[22%] ' >
...
<div className='w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2 ' >
    ...
    For 30 years in a row, U.S. News & World Report has recognized us as one of the best public hospital in the Nation and #1 in Taxes.
    </p>
