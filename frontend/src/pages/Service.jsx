...
const Service = () => {
  ...
  //   axios.post("https://doctor-app-s401.onrender.com/api/getUser", { token: localToken })
  //     .then(result => {
            ...
            <div className="p-4 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  We provide 24/7 emergency care for patients with urgent
                  medical conditions.
                </p>
              </div>
              <button
                className="border-gray-200 border-gray-200"
                size="sm"
                variant="outline"
              >
                Learn More
          ...
          <div className="flex flex-col items-start space-y-2 border border-gray-200 rounded-lg border-gray-200">
            ...
            <div className="p-4 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our experienced surgeons perform a wide range of surgical
                  procedures.
                </p>
              </div>
              <button
          ...
          <div className="flex flex-col items-start space-y-2 border border-gray-200 rounded-lg border-gray-200">
            ...
            <div className="p-4 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  We offer comprehensive care for expectant mothers and their
                  babies.
                </p>
              </div>
              <button
          ...
          <div className="flex flex-col items-start space-y-2 border border-gray-200 rounded-lg border-gray-200">
            ...
            <div className="p-4 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our pediatric specialists provide compassionate and
          ...
          <div className="flex flex-col items-start space-y-2 border border-gray-200 rounded-lg border-gray-200">
            ...
            <div className="p-4 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our imaging services help diagnose and treat various medical
                  conditions.
                </p>
              </div>
              <button
          ...
          <div className="flex flex-col items-start space-y-2 border border-gray-200 rounded-lg border-gray-200">
            ...
            <div className="p-4 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Our team of therapists provides personalized rehabilitation
                  programs.
                </p>
              </div>
              <button
