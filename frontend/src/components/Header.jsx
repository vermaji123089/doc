...
const Header = () => {
  ...
  const handlelogout = () => {
    axios
      .post("https://doctor-app-s401.onrender.com/api/removeToken", {
        token: localToken,
      })
        ...
        <div className="flex items-center justify-between">
              ...
              {navLink.map((item, index) => (
                <li key={index}>
                  <NavLink
                    ...
                    className={(navclass) =>
                      navclass.isActive
                        ? "text-primaryColor text-[16px] leading-7 from-600 "
          ...
          <div className="flex items-center gap-5">
            ...
            {localToken ? (
              <Link to="">
                <button
                  className="bg-primaryColor py5 px-6 text-white font-[600] h-[44px] flex items-center cursor-pointer justify-center rounded-[50px] "
              ...
              <Link to="/login">
                <button className="bg-primaryColor py5 px-6 text-white font-[600] h-[44px] flex items-center cursor-pointer justify-center rounded-[50px] ">
                  Login
                </button>
              </Link>
            )}
